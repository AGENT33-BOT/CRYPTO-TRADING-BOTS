...
CONFIG = {
    'symbols': [
        ...
        # REMOVED: BTC, SOL, XRP, ADA, DOT (losing pairs)
    ],
    ...
    'min_confidence': 85,        # STRICT: 85% min confidence
    ...
    # Risk management - $5 MAX LOSS PER POSITION (CRITICAL)
    'max_loss_usd': 5.0,         # MAX $5 LOSS PER POSITION - HARDCODED
    ...
    'max_position_pct': 0.25,    # Max 25% of account per position (increased for larger balance)
